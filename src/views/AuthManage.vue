...
<script>
    ...
    export default {
        ...
        mounted () {
            ...
            const url =  this.$store.state.base_url + `/acs-manage/policy/show`
            console.log(url)
            const params = {
                'token': token,
            ...
            sureCheck () {
                ...
                if (this.id === '') {
                    ...
                    if (this.p_type !== '' && this.v0 !== '' && this.v1 !== '') {
                        const url = this.$store.state.base_url + '/acs-manage/policy/add'
                        const params = {
                            'token': this.token,
                            'p_type': this.p_type,
                            'v0': this.v0,
                    ...
                    // 修改
                    if (this.p_type !== '' && this.v0 !== '' && this.v1 !== '') {
                        const url = this.$store.state.base_url + '/acs-manage/policy/update'
                        const params = {
                            'token': this.token,
                            'id': this.id,
                            'p_type': this.p_type,
